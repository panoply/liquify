...
`,scope:"company_location"}}},company_location:{summary:"A location of the [company](/docs/api/liquid/objects/company) that a [customer](/docs/api/liquid/objects/customer) is purchasing for.",description:`A location of the [company](https://shopify.dev/docs/api/liquid/objects/company) that a [customer](https://shopify.dev/docs/api/liquid/objects/customer) is purchasing for. To learn about B2B in themes, refer to [Support B2B customers in your theme](https://shopify.dev/themes/pricing-payments/b2b).
...
`}}},content_for_header:{summary:"Dynamically returns all scripts required by Shopify.",global:!0,description:`Dynamically returns all scripts required by Shopify. Include the \`content_for_header\` object in your [layout files](https://shopify.dev/themes/architecture/layouts) between the \`<head>\` and
\`</head>\` HTML tags.
...
`}}},market:{summary:"A group of one or more regions of the world that a merchant is targeting for sales.",description:`A group of one or more regions of the world that a merchant is targeting for sales. To learn more about markets, refer to [the Shopify Markets conceptual
...
`,scope:"quantity_rule"},price:{type:"number",description:`The price of the variant in the currency's subunit. The value is output in the customer's local (presentment) currency.
