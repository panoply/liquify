...
`,type:"object",properties:{metafields:{type:"any",description:`The [metafields](https://shopify.dev/docs/api/liquid/objects/metafield) that are [owned by the app](https://shopify.dev/apps/metafields/app-owned). 
...
`,type:"object",properties:{id:{type:"string",description:`The ID of the block. The ID is dynamically generated by Shopify and is subject to change. You should avoid relying on a literal value of this ID.
...
`,scope:"image"},colors:{type:"any",description:`The brand's colors. To learn about how to access brand colors, refer to [\`brand_color\`](https://shopify.dev/docs/api/liquid/objects/brand_color).
...
`},metafields:{type:"any",description:`The social links for the brand. Social links are stored in [metafields](https://shopify.dev/docs/api/liquid/objects/metafield), and can be accessed using the syntax \`shop.brand.metafields.social_links.<platform>.value\`.
...
`},currency:{type:"any",description:`The currency of the cart. If the store uses multi-currency, then this is the same as the customer's local
...
`}}},closest:{summary:"A drop that holds resources of different types that are the closest to the current context",global:!0,description:`A drop that holds resources of different types that are the closest to the current context This drop is used to hold resources of different types that are the closest to the current context. These resources can be of type \`product\`, \`collection\`, \`article\`, \`blog\`, \`page\`, or \`metaobject\`.
...
`,type:"object",properties:{product:{type:"object",description:`Closest product resource The product resource that is the closest to the current context.
...
`,scope:"product"},collection:{type:"object",description:`Closest collection resource The collection resource that is the closest to the current context.
...
`,scope:"collection"},article:{type:"object",description:`Closest article resource The article resource that is the closest to the current context.
...
`,scope:"article"},blog:{type:"object",description:`Closest blog resource The blog resource that is the closest to the current context.
...
`,scope:"blog"},page:{type:"object",description:`Closest page resource The page resource that is the closest to the current context.
...
`,scope:"page"},metaobject:{type:"object",description:`Closest metaobject resources The metaobject resources that are the closest to the current context.
...
`,scope:"metaobject"}}},collection:{summary:"A [collection](https://help.shopify.com/manual/products/collections) in a store.",template:["collection"],description:`A [collection](https://help.shopify.com/manual/products/collections) in a store. 
...
`},external_id:{type:"string",description:`The external ID of the company. 
...
`,scope:"company_location"},available_locations_count:{type:"number",description:`The number of company locations associated with the customer's company. 
...
`},metafields:{type:"array",description:`The [metafields](https://shopify.dev/docs/api/liquid/objects/metafield) applied to the company. 
...
`},external_id:{type:"string",description:`The external ID of the location. 
...
`},payment_methods:{type:"array",description:`The customer's saved payment methods. 
...
`,scope:"customer_payment_method"},"b2b?":{type:"boolean",description:`Returns \`true\` if the customer is a B2B customer. Returns \`false\` if not. To learn about B2B in themes, refer to [Support B2B customers in your theme](https://shopify.dev/themes/pricing-payments/b2b).
...
`,scope:"company_location"},company_available_locations_count:{type:"number",description:`The number of company locations associated with the customer. 
...
`},current_location:{type:"object",description:`The currently selected company location. To learn about B2B in themes, refer to [Support B2B customers in your theme](https://shopify.dev/themes/pricing-payments/b2b).
...
`,scope:"company"},"has_avatar?":{type:"boolean",description:`Returns \`true\` if an avatar is associated with a customer. Returns \`false\` if not. A customer may have an avatar associated with their account, which can be displayed in the storefront.
...
`}}},customer_payment_method:{summary:"A customer's saved payment method.",description:`A customer's saved payment method. A payment method that a customer has saved to their account for reuse (e.g. a credit card).
...
`,type:"object",properties:{payment_instrument_type:{type:"string",description:`The instrument type of the payment method (e.g credit_card). 
...
`},token:{type:"string",description:`The identifier for the payment method. 
...
`}}},discount_allocation:{summary:"Information about how a discount affects an item.",description:`Information about how a discount affects an item. To learn about how to display discounts in your theme, refer to [Discounts](https://shopify.dev/themes/pricing-payments/discounts).
...
`,literal:["image","swatch","text"]}}},filter_value_display:{summary:"The visual representation of a filter value.",deprecated:!0,description:`\u26A0\uFE0F **DEPRECATED** \u26A0\uFE0F
...
`,scope:"swatch"},image:{type:"object",description:`The visual representation of the filter value when an image is used. Returns an [image](https://shopify.dev/docs/api/liquid/objects/image) drop for the filter value.
...
`,scope:"image"}}},focal_point:{summary:"The focal point for an image.",description:`The focal point for an image. The focal point will remain visible when the image is cropped by the
...
`,literal:["article_link","blog_link","catalog_link","collection_link","collections_link","customer_account_page_link","frontpage_link","http_link","metaobject_link","page_link","policy_link","product_link","search_link"]},levels:{type:"number",description:`The number of nested levels under the link. 
...
`,literal:["authorized","expired","paid","partially_paid","partially_refunded","pending","refunded","unpaid","voided"]},financial_status_label:{type:"any",description:`The localized version of the [financial status](https://shopify.dev/docs/api/liquid/objects/order#order-financial_status) of the order. 
...
`,literal:["complete","fulfilled","partial","restocked","unfulfilled"]},id:{type:"number",description:`The ID of the order. 
...
`,type:"object",properties:{selling_plan_groups:{type:"array",description:`The selling plan groups that the variants of the product are included in. 
...
`,scope:"selling_plan_group"},metafields:{type:"any",description:`The [metafields](https://shopify.dev/docs/api/liquid/objects/metafield) applied to the product. 
...
`,scope:"product_option"},category:{type:"object",description:`The taxonomy category for the product 
...
`,scope:"taxonomy_category"},variants:{type:"array",description:`The variants of the product. 
...
`,scope:"media"},images:{type:"array",description:`The images attached to the product. 
...
`,scope:"image"},price_min:{type:"number",description:`The lowest price of any variants of the product in the currency's subunit. 
...
`},selected_selling_plan:{type:"object",description:`The currently selected selling plan. If no selling plan is selected, then \`nil\` is returned.
...
`},swatch:{type:"object",description:`Returns a [swatch](https://shopify.dev/docs/api/liquid/objects/swatch) drop for the product option value. If there is no saved \`color\` or \`image\` content for the swatch, then the return value is \`nil\`. 
...
`},available:{type:"boolean",description:`Whether or not the option value is available. In the context of the selected values for previous options, indicates whether the current option value has any purchaseable combinations in any subsequent options, or whether the current option value is purchaseable if there are no subsequent options.
...
`},variant:{type:"object",description:`The variant associated with this option value combined with the other currently selected option values, if one exists. If this option value is selected (\`selected == true\`), this returns the \`selected_or_first_available_variant\`.
...
`,scope:"variant"},product_url:{type:"string",description:`Returns a URL if the option value may be associated with another product, nil otherwise. \`\`\`liquid
...
`},options:{type:"object",description:`The values of the variant for each [product option](https://shopify.dev/docs/api/liquid/objects/product_option). 
...
`,scope:"product_option_value"},option1:{type:"string",description:`\u26A0\uFE0F **DEPRECATED** \u26A0\uFE0F
...
`,scope:"store_availability"},requires_selling_plan:{type:"boolean",description:`Returns \`true\` if the variant's product is set to require a \`selling_plan\` when being added to the cart. Returns \`false\` if not. 
...
`},storefront_login_url:{type:"string",description:`[New customer accounts](https://help.shopify.com/en/manual/customers/customer-accounts/new-customer-accounts) login page. Redirects to the storefront page the customer was on before visiting the login page. 
...
`,scope:"sort_option"},sort_by:{type:"any",description:`The sort order of the search results. This is determined by the \`sort_by\` URL parameter. If there's no \`sort_by\` URL parameter, then the value is \`nil\`.
...
`},price_with_discounts:{type:"number",description:`The price of the shipping method in the currency's subunit, after discounts have been applied, including order level discounts. The value is output in the customer's local (presentment) currency.
...
`,scope:"currency"},metafields:{type:"any",description:`The [metafields](https://shopify.dev/docs/api/liquid/objects/metafield) applied to the store. 
...
`,scope:"brand"},metaobjects:{type:"any",description:`\u26A0\uFE0F **DEPRECATED** \u26A0\uFE0F
...
`}}},taxonomy_category:{summary:"The taxonomy category for a product",description:`The taxonomy category for a product 
...
`,type:"object",properties:{gid:{type:"string",description:`The public node ID for the category, formatted as a Shopify GID. 
...
`},id:{type:"string",description:`The public node ID for the category 
...
`},name:{type:"string",description:`The localized category name 
...
`},ancestors:{type:"array",description:`All parent nodes of the current taxonomy category. 
...
`,scope:"taxonomy_category"}}},theme:{summary:"Information about the current theme.",global:!0,deprecated:!0,description:`\u26A0\uFE0F **DEPRECATED** \u26A0\uFE0F
...
`}}},powered_by_link:{summary:"Creates an HTML link element that links to a localized version of `shopify.com`, based on the locale of the store.",global:!0,description:`Creates an HTML link element that links to a localized version of \`shopify.com\`, based on the locale of the store. 
...
> **NOTE**
>
> To iterate over a data set and create pages for individual chunks of data, use pagination. Enable in your template\u2019s front matter by adding the pagination key.`,properties:{items:{type:"array",description:"Array of current page\u2019s chunk of data"},pageNumber:{type:"number",description:"Current page number, `0` indexed"},hrefs:{type:"array",description:"Array of all page hrefs (in order)",items:"string"},href:{type:"object",properties:{next:{type:"string",description:'Put inside `<a href="">Next Page</a>`'},prev:{type:"string",description:'Put inside `<a href="">Previous Page</a>`'},first:{type:"string"},last:{type:"string"}}},pages:{type:"array",description:"Array of all chunks of paginated data (in order)"},page:{type:"object",properties:{next:{type:"any",description:'Put inside `<a href="">Next Page</a>`'},prev:{type:"any",description:'Put inside `<a href="">Previous Page</a>`'},first:{type:"any"},last:{type:"any"}}}},reference:{name:"Eleventy Liquid",url:"https://www.11ty.dev/docs/pagination/"}}};var Te=F({},ie,j),we=F({},L);var k=process.cwd(),q=`${y.default.gray("[")}SPECS${y.default.gray("]")} ${y.default.magenta("RUN")}`,{log:g}=console;Se();function Se(){g(`${q} ${y.default.magenta.bold("Building Shopify Specifications")}`),ke(),xe(),g(`${q} ${y.default.magenta.bold("Finished Shopify Specifications")}`)}function Ue(){let e=new Date,n=e.getFullYear(),p=e.getMonth()+1,t=e.getDay(),r=i=>({1:"January",2:"February",3:"March",4:"April",5:"May",6:"June",7:"July",8:"August",9:"September",10:"October",11:"November",12:"December"})[i];return`${(i=>{let s=i%10,d=i%100;return i+(s===1&&d!==11?"st":s===2&&d!==12?"nd":s===3&&d!==13?"rd":"th")})(t)} ${r(p)} ${n}`}function Fe(e,n,p){return`import { ${e} } from '../..'

export const ${n}: ${e} = ${p}`}function m(e){return e=e.replace(/&lt;/g,"<"),e=e.replace(/&gt;/g,">"),e=e.replace(/&quot;/g,'"'),e=e.replace(/&#39;/g,"'"),e=e.replace(/&amp;/g,"&"),e}function z(e,n,p){let t=[],{name:r,summary:f=null,description:i=null,examples:s,deprecated:d,deprecation_reason:c}=n;if(d===!0&&(t.push("\u26A0\uFE0F **DEPRECATED** \u26A0\uFE0F"),c!==""?t.push(m(c),"---"):t.push("No deprecation reason has been provided by the Shopify team \u{1F921}.","---")),i!==""&&f!==null){let a=m(i).replace(/>\s(Tip|Note):/g,`

**$1**
`).replace(/\(\/(docs\/api.*(?=\)))/g,"(https://shopify.dev/$1").replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1"),h=m(f).replace(/\(\/(docs\/api.*(?=\)))/g,"(https://shopify.dev/$1").replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1");a.trimStart()[0]===">"?t.push(m(h),a):t.push(m(h)+" "+a)}else{let a="";if(i!==""&&(a=m(i).replace(/>\s(Tip|Note):/g,`

**$1**
`).replace(/\(\/(docs\/api.*(?=\)))/g,"(https://shopify.dev/$1").replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1")),f.length>0){let h=m(f).replace(/\(\/(docs\/api.*(?=\)))/g,"(https://shopify.dev/$1").replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1");a.trimStart()[0]===">"?t.push(m(h),a):t.push(m(h)+" "+a)}t.push(a)}if(s.length>0){let[a]=s;a.name===""?t.push("#### Example"):t.push(`#### ${a.name}`),a.description!==""&&t.push(m(a.description)),a.raw_liquid!==""&&t.push("```liquid",m(a.raw_liquid),"```")}return t.push("---"),p?t.push(`[Shopify Liquid](https://shopify.dev/docs/api/liquid/${e}/${p}/${r})
`):t.push(`[Shopify Liquid](https://shopify.dev/docs/api/liquid/${e}/${r})
`),t.push(`Last Updated: ${Ue()}`,`
`),t.join(`

`)}function xe(){g(`${q} ${y.default.magenta("Shopify Filters")}`);let e=(0,S.join)(k,"node_modules/.specs/data","filters.json"),n=w.default.readFileSync(e).toString(),p=JSON.parse(n),t={},r=x.filters;for(let s of p)if(!(s.name in r))if(t[s.name]={},t[s.name].description=z("filters",s),s.return_type[0].type==="string"?t[s.name].returns="string":s.return_type[0].type==="number"?t[s.name].returns="number":s.return_type[0].type==="boolean"?t[s.name].returns="boolean":s.return_type[0].type==="array"?t[s.name].returns="array":s.return_type[0].type==="boolean"?t[s.name].returns="boolean":s.return_type[0].type==="object"?t[s.name].returns="object":t[s.name].returns="any",s.deprecated===!0&&(t[s.name].deprecated=s.deprecated),s.parameters.length===0){let d=[],c=[],a=s.syntax.split(" ");if(a[2][a[2].length-1]===":"){d.push(a[2]);let h=0;for(let l of a.slice(3)){h=h+1;let u;l.slice(0,-1)==="string"?u="string":l.slice(0,-1)==="number"?u="number":l.slice(0,-1)==="boolean"?u="boolean":l.slice(0,-1)==="array"?u="array":l.slice(0,-1)==="boolean"?u="boolean":l.slice(0,-1)==="object"?u="object":u="any",l[l.length-1]===","?(u==="string"?d.push("'$"+h+"',"):d.push("$"+h+","),c.push({type:u,required:!0})):(u==="string"?d.push("'$"+h+"'"):d.push("$"+h+","),c.push({type:u,required:!0}))}t[s.name].snippet=d.join(" "),t[s.name].arguments=c}}else{let d=s.syntax.split(" "),c=[],a=[];c.push(d[2]),d.splice(0,3);for(let h=0;h<s.parameters.length;h++){let l=s.parameters[h];if(d.length>0&&d[0][d[0].length-1]===","){if("arguments"in t[s.name]&&t[s.name].arguments.length<0)for(let u=0;u<d.length;u++){let b;l.types[0]==="string"?b="string":l.types[0]==="number"?b="number":l.types[0]==="boolean"?b="boolean":l.types[0]==="array"?b="array":l.types[0]==="boolean"?b="boolean":l.types[0]==="object"?b="object":b="any";let R=d[u],U={type:b};l.required===!0&&(U.required=!0),l.description!==""&&(U.description=m(l.description).replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1")),a.push(U),R[R.length-1]===","?b==="string"?c.push("'$"+(u+1)+"',"):c.push("$"+(u+1)+","):b==="string"?c.push("'$"+(u+1)+"'"):c.push("$"+(u+1))}}else if(Array.isArray(t[s.name].arguments)){a.length===0&&a.push({type:"parameter",value:{}}),a[a.length-1].type!=="parameter"&&a.push({type:"parameter",value:{}}),l.required&&c.push(`${l.name}:`,"${"+(h+1)+"}");let u;l.types[0]==="string"?u="string":l.types[0]==="number"?u="number":l.types[0]==="boolean"?u="boolean":l.types[0]==="array"?u="array":l.types[0]==="boolean"?u="boolean":l.types[0]==="object"?u="object":u="any",a[a.length-1].value[l.name]={type:u,required:l.required},l.description!==""&&(a[a.length-1].value[l.name].description=m(l.description).replace(/\]\(\/(.*)(?=\))/g,"](https://shopify.dev/$1"))}}c.length>0&&(c.length===1&&c[0][c[0].length-1]===":"&&(c[0]=c[0].slice(0,-1)),t[s.name].snippet=c.join(" ")),a.length>0&&(t[s.name].arguments=a)}let f=JSON.stringify(t,function(s,d){return d&&d.exec===RegExp.prototype.exec?new RegExp(d).source:d},2);Object.keys(t).length>0&&(g(q+" "+y.default.bold.redBright("NEW FILTERS AVAILABLE")),g(q+y.default.cyan(` Writing filters JSON: ${y.default.whiteBright("data/liquid/shopify/filters.json")} `)),w.default.writeFileSync((0,S.join)(k,"data/liquid/shopify/filters.json"),f),Object.keys(t).forEach(s=>{g(q+" "+y.default.white(s))}))}function ke(){g(`${q} ${y.default.magenta("Shopify Objects")}`);let e=(i,s)=>{let d={scope:null,items:null,type:"any",literal:null},c=i[0].type,a=i[0].array_value;c==="string"||c==="boolean"||c==="number"?d.type=c:c==="array"?(d.type=c,a==="string"||a==="boolean"||a==="number"?d.items=a:d.scope=a):c!==""&&s.some(h=>h.name===c)&&(d.type="object",d.scope=c);for(let{name:h}of i)h!==""&&(d.literal===null&&(d.literal=[]),d.literal.push(h));return d},n=(0,S.join)(k,"node_modules/.specs/data","objects.json"),p=w.default.readFileSync(n).toString(),t=JSON.parse(p),r={};for(let i of t){if(r[i.name]={summary:i.summary},i.access.global===!0&&(r[i.name].global=i.access.global),i.deprecated===!0&&(r[i.name].deprecated=i.deprecated),i.access.template.length>0&&(r[i.name].template=i.access.template),r[i.name].description=z("objects",i),i.return_type.length>0){let{type:s,scope:d,literal:c}=e(i.return_type,t);c!==null&&(r[i.name].literal=c),d!==null?(r[i.name].type=s,r[i.name].scope=d):r[i.name].type=s}if(i.properties.length>0){r[i.name].type="object",typeof r[i.name].properties!="object"&&(r[i.name].properties={});for(let s of i.properties)if(g(y.default.gray(`  - ${s.name}`)),r[i.name].properties[s.name]={type:"any"},r[i.name].properties[s.name].description=z("objects",s,i.name),i.deprecated===!0&&(r[i.name].properties[s.name].deprecated=i.deprecated),s.return_type.length>0){let{type:d,scope:c,literal:a}=e(s.return_type,t);a!==null&&(r[i.name].properties[s.name].literal=a),c!==null?(r[i.name].properties[s.name].type=d,r[i.name].properties[s.name].scope=c):r[i.name].properties[s.name].type=d}}else r[i.name].type!=="array"&&(r[i.name].const=!0)}let f=JSON.stringify(r,null,2);g(q+y.default.cyan(` Writing objects JSON: ${y.default.whiteBright("data/liquid/shopify/objects.json")} `)),w.default.writeFileSync((0,S.join)(k,"data/liquid/shopify/objects.json"),f),g(q+y.default.cyan(` Writing objects DATA: ${y.default.whiteBright("src/liquid/data/shopify/objects.ts")} `)),w.default.writeFileSync((0,S.join)(k,"src/liquid/data/shopify/objects.ts"),Fe("Objects","objects",f))}
