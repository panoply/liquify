    ...
    link: {
      ...
      properties: {
        active: {
          ...
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-active'
        },
        child_active: {
          type: 'boolean',
          ...
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-child_active'
        },
        child_current: {
          type: 'boolean',
          decription: 'Returns `true` if a child link has a link object with link.current equal to `true`. Returns `false` if no child links have a link object with link.current equal to `true`.',
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-child_current'
        },
        current: {
          type: 'boolean',
          decription: "Returns `true` if the page content associated with the `link` is considered a match to the current page. Returns `false` if the content isn't considered a match",
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-current'
        },
        levels: {
          type: 'integer',
          description: 'Returns the number of nested levels that a link contains.',
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-levels'
        },
        links: {
          type: 'array',
        ...
        object: {
          ...
          link: 'https://shopify.dev/docs/themes/liquid/reference/objects/link#link-object'
        },
        title: {
          type: 'string',
          description: 'Returns the title of the link',
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-title'
        },
        type: {
          type: 'string',
          description: 'Returns the type of the link. The possible values are:\n\n- collection_link\n- product_link\n- page_link\n- blog_link\n- relative_link\n- http_link',
          link: 'https://help.shopify.com/themes/liquid/objects/link#link-type'
        },
        url: {
          type: 'string',
          description: 'Returns the URL of the link.',
          link: 'https://help.shopify.com/themes/liquid/objects/link#url'
        }
      }
    },
    linklist: {
      ...
      properties: {
        handle: {
          ...
          link: 'https://help.shopify.com/themes/liquid/objects/linklist#linklist-handle'
        },
        levels: {
          type: 'integer',
          description: 'Returns the number of nested levels that a linklist contains.',
          link: 'https://help.shopify.com/themes/liquid/objects/linklist#linklist-levels'
        },
        links: {
          type: 'array',
          description: 'Returns an array of links in the linklist.',
          link: 'https://help.shopify.com/themes/liquid/objects/linklist#linklist-links'
        },
        title: {
          type: 'string',
          description: 'Returns the title of the linklist',
          link: 'https://help.shopify.com/themes/liquid/objects/linklist#linklist-title'
        }
      }
    },
    images: {
