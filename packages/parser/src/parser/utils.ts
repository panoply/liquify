...
/**
 * Validate if property exists in object
 */
export const has = (prop: string | number, object: object): boolean => prop in object;

/**
 * Retrive last value within an array
 */
 ...
 */
export const remove = (prop: string | number, object: object) => delete object[prop];
