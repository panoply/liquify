...
export declare type Engine = 'standard' | 'shopify' | 'jekyll' | 'eleventy';
...
export declare type Specifiers = IFilter & IObject & ITag;
export declare type TagScopes = string[];
export declare type IScopes = string[];
export declare type ISpecs = ('Standard' | 'Shopify' | 'Jekyll' | 'Eleventy');
export declare type ITemplates = 'customer/register' | 'customer/reset_password' | 'customer/activate_account' | 'customer/account' | 'customer/login' | 'customer/addresses' | 'customer/order' | '404' | 'article' | 'blog' | 'cart' | 'collection' | 'gift_card' | 'index' | 'list-collections' | 'page.contact' | 'page' | 'password' | 'product' | 'search';
...
export declare type Arguments = IArgument.Argument | IArgument.Parameter;
export {};
